...
def sync_wallet_resolutions(lookback_markets: int = 200) -> int:
    """Check open records against recently-resolved markets and mark them
    correct/incorrect. Returns how many got resolved this pass."""
    records = _load_records()
    ...
    try:
        ...
        log.warning("Could not fetch resolved markets for wallet tracking: %s", e)
        return 0
    ...
    for key in open_keys:
        r = records[key]
        actual_outcome = resolved_by_market.get(r["market_id"])
